...
/*
trait GenericSerializationSpec[Json] extends Spec with ShouldMatchers with JsonProtocol[Json] with JsonSerialization[Json] {
...
//      """
//      import rosetta.json._
//      val js = json.deserialize[JsValue]
//    }
//  }
}
